...
function bones_ahoy() {
  ...
  add_action( 'widgets_init', 'phg_gold_widgets_init' );
...
// Customized Sidebar and Widgets
function phg_gold_widgets_init() {
  ...
  register_widget( 'phg_gold_social_widget' );
}
...
/**
 * Sub Page Gallery Nav Menu
 */
require get_template_directory() . '/inc/subpagenav.php';
...
add_action('wp_enqueue_scripts', 'phg_gold_scripts');
